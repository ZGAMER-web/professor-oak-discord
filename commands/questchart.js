module.exports.run = (client, message, args) => {
  ...
  const embed = new Discord.RichEmbed()
    ...
    .setTitle("**Daily Field Research Reportings**")
    
    .setColor(0x00AE86)
    .setDescription("Report Field Research tasks that you've picked up from Pokestops. See the chart below for reference. This channel is cleared daily. Happy exploring & reporting, Trainers!")
