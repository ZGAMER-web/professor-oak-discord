module.exports.run = (client, message, args) => {
  ...
  .setDescription("This simulation was done using level 30 attackers and no dodging. Beating " + name + " should take " + trainers_needed + " Trainer(s) with Pokemon of this strenght. With no counters, double the amount shown. Bringing an extra Trainer or two never hurts!\n(L) = Legacy")
